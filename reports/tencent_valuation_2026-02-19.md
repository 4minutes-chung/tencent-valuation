# Tencent Valuation V4 Report (2026-02-19)
...
|---|---:|---:|---:|---:|
| bad | 242.49 | 171.61 | 356.88 | 0.76 |
| base | 357.15 | 274.50 | 445.39 | 0.48 |
| extreme | 192.08 | 124.25 | 356.88 | 1.21 |
| expected | 292.26 | 192.08 | 357.15 | 0.56 |
...
- `peer_input_coverage`: **fail** - Peer input coverage check against data/raw/<asof>/peer_fundamentals.csv.
