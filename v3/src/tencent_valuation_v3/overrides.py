...
def _fetch_spot_price_hkd(ticker: str, asof: str, timeout: int = 20) -> float:
    symbol = ticker.lower().replace(".hk", ".hk")
...
def build_overrides(
    ...
    latest_release = release_files["Tencent Announces 2025 Third Quarter Results"]
        ...
        segment_rows.append(
            {
                ...
                "source_doc": "Tencent Announces 2025 Third Quarter Results",
